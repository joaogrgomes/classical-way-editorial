    ...
    <div className="max-w-[1120px] mx-auto px-[clamp(16px,4vw,48px)] py-12 lg:flex gap-12">
      ...
      <article className="max-w-[680px]">
        ...
        <blockquote className="border-l-4 border-gd-600 pl-6 my-8">
          <p className="font-heading italic text-[1.56rem] text-gy-700 leading-[1.6]">
        ...
        <div className="mb-10">
          ...
          <div className="flex items-center gap-3 mb-3">
            <div className="w-12 h-12 bg-gy-200 rounded-full flex items-center justify-center">
              <span className="font-display text-[0.6rem] text-gy-500 uppercase">CM</span>
            </div>
            <div>
          ...
          {relatedArticles.map((a) => (
            <Link key={a.title} to="/artigos/exemplo" className="group">
              ...
              <div className="flex justify-between items-center">
                <span className="font-display text-[0.55rem] tracking-[0.12em] uppercase text-gy-400">{a.author}</span>
                <span className="font-display text-[0.55rem] tracking-[0.1em] uppercase text-gy-300">{a.date}</span>
              </div>
            </Link>
          ))}
        </div>
