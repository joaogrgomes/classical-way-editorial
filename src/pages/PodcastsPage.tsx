...
const PodcastsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Featured Podcast */}
      <div className="border-b border-gy-100 py-10 lg:py-14">
        <div className="max-w-[1120px] mx-auto px-[clamp(16px,4vw,48px)]">
          <div className="flex flex-col md:flex-row gap-6 lg:gap-10 items-start">
            <img
              src={podcastCover}
              alt="The Classical Way Podcast"
              className="w-[200px] lg:w-[240px] aspect-square object-cover shadow-[0_6px_24px_rgba(0,0,0,0.1)] flex-shrink-0 mx-auto md:mx-0"
              width={512}
              height={512}
              loading="lazy"
            />
            <div className="flex-1">
              <h2 className="font-heading text-[1.5rem] lg:text-[1.8rem] italic font-semibold text-gy-900 leading-[1.25] mb-2">
                The Classical Way Podcast
              </h2>
              <p className="font-body text-[1rem] text-gy-500 leading-[1.7] mb-5 max-w-[480px]">
                Conversas semanais sobre educação clássica, artes liberais e formação cristã. Porque ensinar é uma vocação que exige sabedoria, não apenas técnica.
              </p>
              <div className="flex gap-4 flex-wrap">
                <a href="#episodios" className="font-display text-[0.5rem] tracking-[0.14em] uppercase bg-bx-700 text-white px-4 py-[7px] hover:bg-bx-600 transition-colors">
                  Todos os episódios
                </a>
                <button className="font-display text-[0.5rem] tracking-[0.14em] uppercase border border-gy-200 text-gy-600 px-4 py-[7px] hover:border-gy-400 transition-colors">
                  Inscrever-se ↓
                </button>
              </div>
            </div>
