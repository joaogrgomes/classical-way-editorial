...
const HeroBanner = () => (
  <section className="relative min-h-[420px] lg:min-h-[520px] flex items-end overflow-hidden">
    ...
    <div className="relative z-10 max-w-[1120px] mx-auto px-[clamp(16px,4vw,48px)] w-full pb-12 lg:pb-16 pt-20">
      <span className="font-display text-[0.5rem] tracking-[0.24em] uppercase text-gd-500 mb-3 block">
        Destaque
      </span>
      <h2 className="font-heading text-[clamp(1.6rem,4vw,2.8rem)] italic font-bold text-white/95 leading-[1.15] max-w-[680px] mb-4">
        A educação clássica como caminho de formação integral da alma
      </h2>
      <p className="font-body text-[1.05rem] text-white/60 max-w-[520px] leading-[1.7] mb-6">
      ...
      <Link
        to="/artigos"
        className="inline-block font-display text-[0.52rem] tracking-[0.16em] uppercase bg-gd-700 text-white px-5 py-[9px] hover:bg-gd-600 transition-colors"
      >
        Ler artigo →
      </Link>
    </div>
