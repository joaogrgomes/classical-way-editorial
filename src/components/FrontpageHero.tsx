  ...
  <section className="bg-background border-b-2 border-gy-900">
    <div className="max-w-[1120px] mx-auto px-[clamp(16px,4vw,48px)] grid grid-cols-1 lg:grid-cols-[1fr_1px_340px] gap-0 items-start">
      ...
      <div className="py-5 lg:pr-8">
        <div className="font-display text-[0.52rem] tracking-[0.22em] uppercase text-bx-700 flex items-center gap-3 mb-3.5">
          Artigo em Destaque
        ...
        <div className="flex items-center flex-wrap gap-3.5 font-display text-[0.52rem] tracking-[0.14em] uppercase text-gy-400">
      ...
      <div className="py-5 lg:pl-7 border-t lg:border-t-0 border-gy-100">
        <p className="font-display text-[0.5rem] tracking-[0.22em] uppercase text-gy-300 mb-4 pb-2.5 border-b border-gy-100">
          Outros Destaques
        </p>
        {sidebarItems.map((item) => (
          ...
          >
            <span className="font-display text-[0.44rem] tracking-[0.18em] uppercase text-bx-600">
              {item.category}
            </span>
            ...
            <span className="font-display text-[0.44rem] tracking-[0.12em] uppercase text-gy-300">
              {item.author}
            </span>
          </article>
        ))}
